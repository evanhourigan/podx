...
class PodcastAnalysisConfig(BaseModel):
    ...
    show_aliases: list[str] = Field(default_factory=list, description="Alternative names for matching")
    
    # Analysis settings
    podcast_type: PodcastType = Field(default=PodcastType.GENERAL, description="Podcast type for analysis")
    ...
    custom_prompt_additions: Optional[str] = Field(
        default=None,
        description="Additional prompt instructions for this podcast"
    )
