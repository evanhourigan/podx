...
class AlignBrowser:
    ...
    def browse(self) -> Optional[Dict[str, Any]]:
        ...
        while True:
            ...
            # Create header
            title = f"Episodes Available for Transcription Alignment (Page {self.current_page + 1}/{self.total_pages})"
            ...
            # Show options
            options = f"[cyan]1-{len(self.transcripts)}:[/cyan] Select episode to align"
