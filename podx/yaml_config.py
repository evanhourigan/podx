...
class NotionDatabase(BaseModel):
    ...
    title_property: str = Field(default="Name", description="Property name for episode title")
    date_property: str = Field(default="Date", description="Property name for episode date")
    tags_property: Optional[str] = Field(default="Tags", description="Property name for tags/keywords")
...
class PodxYamlConfig(BaseModel):
    ...
    environment: Optional[str] = Field(default=None, description="Environment name (dev, prod, etc.)")
    
    # Default pipeline settings
    defaults: Optional[PipelineDefaults] = Field(default=None, description="Global pipeline defaults")
    ...
    def create_example_config(self) -> None:
        ...
        example_config = PodxYamlConfig(
            ...
            podcasts={
                ...
                "lex": PodcastMapping(
                    names=["Lex Fridman Podcast", "Lex Fridman", "Artificial Intelligence Podcast"],
                    analysis=AnalysisConfig(
                ...
                "business": PodcastMapping(
                    names=["Y Combinator Podcast", "YC Podcast", "The Tim Ferriss Show"],
                    analysis=AnalysisConfig(
                        type=PodcastType.BUSINESS
                    ),
                    pipeline=PipelineDefaults(
                        align=True,
                        deepcast=True,
