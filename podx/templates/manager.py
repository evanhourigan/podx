...
class TemplateManager:
    ...
    def get_builtin_templates(self) -> Dict[str, DeepcastTemplate]:
        ...
        return {
            ...
            "knowledge-oracle": DeepcastTemplate(
                name="knowledge-oracle",
                description="Cross-domain knowledge extraction. Mines transferable frameworks, mental models, contrarian insights, and actionable strategies, then maps them to consulting, therapy practice marketing, personal development, and other domains. Designed to run as a second analysis pass alongside format-based templates.",
                format="knowledge-extraction",
                system_prompt=(
                    "You are a knowledge architect who extracts transferable insights from conversations.\n"
                    "Your job is NOT to summarize what happened in this episode. Instead, you are mining\n"
                    "it for frameworks, mental models, strategies, principles, and contrarian ideas that\n"
                    "can be applied ACROSS DOMAINS — especially:\n\n"
                    "1. **Technology consulting** — advising enterprises on engineering practices, AI adoption,\n"
                    "   organizational design, product strategy, and digital transformation\n"
                    "2. **Therapy practice marketing** — building, branding, and growing private therapy\n"
                    "   practices including website content, client acquisition, and practice differentiation\n"
                    "3. **Personal development** — individual growth, career strategy, learning approaches,\n"
                    "   productivity systems, and mindset shifts\n"
                    "4. **Leadership & management** — team building, organizational design, decision-making\n"
                    "   frameworks, culture, and change management\n"
                    "5. **Engineering & technical** — software architecture, development practices, tooling,\n"
                    "   and technical strategy\n\n"
                    "For each insight you extract, think: 'If someone working in a completely different\n"
                    "field heard this, would it change how they think or act?' If yes, capture it.\n\n"
                    "Pay special attention to:\n"
                    "- Analogies and metaphors that translate across fields\n"
                    "- Counterintuitive findings that challenge conventional wisdom\n"
                    "- Specific numbers, metrics, or results that anchor abstract ideas\n"
                    "- Frameworks that could be applied as templates in other contexts\n"
                ...
                map_instructions=(
                    "For this chunk of the transcript, extract:\n"
                    "1. Any frameworks, models, or structured approaches described\n"
                    "2. Contrarian or surprising claims with supporting evidence\n"
                    "3. Specific actionable strategies with enough detail to implement\n"
                    "4. Memorable quotes that capture big ideas concisely\n"
                    "5. Connections to well-known concepts from business, psychology, or technology\n\n"
                    "Be thorough — capture insights even if they seem tangential. The reduce phase\n"
                    "will synthesize and prioritize. Include timestamps for everything.\n\n"
                    "Focus on TRANSFERABILITY: would this insight be useful to someone in a different\n"
                    "field? If an engineering insight could inform how a therapy practice is run,\n"
                    "or a leadership lesson could reshape a consulting engagement, flag it."
                ),
                user_prompt=(
                    "Analyze this podcast transcript for transferable knowledge and cross-domain insights.\n\n"
                    "Title: {{title}}\n"
                    "Show: {{show}}\n"
                    "Duration: {{duration}} minutes\n"
                    "Speakers: {{speakers}}\n\n"
                    ...
                    "List every framework, mental model, or structured approach mentioned in the episode.\n"
                    "For each one:\n"
                    "- **Name**: Give it a concise, memorable name\n"
                    "- **How it works**: 2-3 sentences explaining the framework\n"
                    "- **Source context**: Where/how it was described in the episode (with timestamp)\n"
                    "- **Cross-domain applications**: Specifically how this could apply to (a) consulting,\n"
                    "  (b) therapy practice marketing, (c) personal development. Only include domains\n"
                    "  where the transfer is genuinely useful — don't force it.\n\n"
                    "## Contrarian Insights\n\n"
                    "Capture ideas that challenge conventional wisdom or offer surprising perspectives.\n"
                    "For each:\n"
                    "- The conventional view being challenged\n"
                    "- The contrarian position and supporting evidence\n"
                    "- Why this matters (with timestamp)\n\n"
                    "## Actionable Strategies\n\n"
                    "Specific, implementable tactics mentioned — not generic advice, but concrete\n"
                    "'do X to achieve Y' recommendations with enough detail to actually act on them.\n"
                    "Tag each with which domains it applies to: [Consulting] [Therapy Sites]\n"
                    "[Personal Development] [Leadership] [Engineering]\n\n"
                    "## Quotable Insights\n\n"
                    "The most powerful, concise statements that capture big ideas in memorable language.\n"
                    "Include exact quotes with timestamps and speaker attribution. Focus on quotes that\n"
                    "could be referenced in articles, presentations, or conversations.\n\n"
                    "## Knowledge Connections\n\n"
                    "Identify connections to broader themes, other well-known frameworks, or ideas that\n"
                    "readers familiar with business/psychology/technology literature would recognize.\n"
                    "For example: 'This echoes Clayton Christensen's jobs-to-be-done framework' or\n"
                    "'This is essentially the therapeutic concept of reframing, applied to engineering.'\n"
                    "These connections make the knowledge more retrievable and more useful.\n\n"
                    "## Domain-Specific Takeaways\n\n"
                    "### For Consulting Practice\n"
                    "Bullet the 3-5 most relevant insights for someone advising enterprises on\n"
                    "technology, AI adoption, or organizational transformation. Be specific about\n"
                    "how to apply each insight with a client.\n\n"
                    "### For Therapy Practice Marketing\n"
                    "Bullet the 3-5 most relevant insights for someone building and marketing a\n"
                    "therapy practice — website content, client messaging, practice differentiation,\n"
                    "or business model. If the episode has limited relevance here, say so honestly\n"
